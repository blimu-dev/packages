...
export default defineConfig([
  {
    ...
    external: [],
    onSuccess: async () => {
      // Copy templates to dist after CLI build
      const { copyFileSync, mkdirSync, readdirSync, statSync } =
        await import("fs");
  ...
  },
  {
    ...
    // This ensures the library works even if users don't have all dependencies installed
    external: [],
